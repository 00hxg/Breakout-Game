...
def paddlemoveright():
    if paddle.xcor() <= 155:
        paddle.forward(20)
screen.onkey(paddlemoveright, "d")
screen.listen()

def paddlemoveleft():
    if paddle.xcor() >= -155:
        paddle.forward(-20)
screen.onkey(paddlemoveleft, "a")
screen.listen()
...
row1 = brick_row("red", y_brick)
row2 = brick_row("dark orange", y_brick - (brick_thickness + gap_size))
row3 = brick_row("yellow", y_brick - 2 * (brick_thickness + gap_size))
row4 = brick_row("lime", y_brick - 3 * (brick_thickness + gap_size))
row5 = brick_row("blue", y_brick - 4 * (brick_thickness + gap_size))
...
def cleanup(ball, paddle, bricks):
    ...
    turtle.hideturtle()
    turtle.color("black")
    turtle.write("Game Over!!", align="center", font=("Times New Roman", 60, "normal"))
...
def cleanup_win(ball, paddle, bricks):
    ...
    turtle.hideturtle()
    turtle.color("black")
    turtle.write("You WON!!", align="center", font=("Times New Roman", 60, "normal"))
